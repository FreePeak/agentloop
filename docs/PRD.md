...
| **System One abstraction** | one client, one URL (`AGENTLOOP_SYSTEMONE_URL`): onegw by default, a backend directly when named; backends Jev and/or Laya | swap by URL and/or onegw combo; no agentloop code change | docs/JEV-INTEGRATION.md §3 |
